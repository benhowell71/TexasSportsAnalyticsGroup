...
This was a fun project, and a good way to get started with NBA shot tracking data. You can find the code to this piece [here](https://github.com/benhowell71/NBA_shots/blob/main/shots.Rmd).
